...
class MainApplication(tk.Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.canvas = tk.Canvas(self.frame, height=500, width=self.width, bg = "white")
        ...
        self.gslider = tk.Scale(self.master, from_=0.001, to=0.003,resolution = 0.0001, orient="vertical", length = 400, sliderlength = 30)
        ...
        self.cslider = tk.Scale(self.master, from_=1, to=300, orient="vertical", length = 400, sliderlength = 30)
        ...
        self.pslider = tk.Scale(self.master, from_=0.0001, to=10,resolution = 1, orient="vertical", length = 400, sliderlength = 30)
        self.pslider.set(5)
    ...
    def show_dot(self):
        ...
        for i in zip(self.x_list,self.y_list):
            x_dot = i[0][0]
            y_dot = i[1]
            self.canvas.create_oval((x_dot-1),(y_dot-1), (x_dot+1),(y_dot+1), fill="red", width=7)
    ...
    def show_line(self):
        ...
        for i in zip(self.x_plot,self.y_plot):
            x = i[0][0]
            y = i[1][0]
            self.canvas.create_oval((x-1),(y-1), (x+1),(y+1), fill="red", tags="line", width=1)
